...
% Metadatos PDF
\hypersetup{
  pdftitle={Modelo de evaluación y cuantificación de deuda técnica acumulada por el uso de inteligencia artificial generativa en el desarrollo de aplicaciones empresariales: caso de estudio en el sector de seguros y reaseguros},
  pdfauthor={Willian José Pillaca Meneses},
  pdfsubject={Plan de Tesis de Maestría en Ingeniería de Sistemas},
  pdflang={es-PE}
}

% Datos generales usados por permisos y otros archivos de contenido
\newcommand{\tesisTitulo}{Modelo de evaluación y cuantificación de deuda técnica acumulada por el uso de inteligencia artificial generativa en el desarrollo de aplicaciones empresariales: caso de estudio en el sector de seguros y reaseguros}
...
\title{Modelo de evaluación de Deuda Técnica Generativa en aplicaciones de Seguros y Reaseguros}

%Título para CARÁTULA (Siempre en mayuscula y sin saltos de linea)
\titlecaratula{MODELO DE EVALUACIÓN Y CUANTIFICACIÓN DE DEUDA TÉCNICA ACUMULADA POR EL USO DE INTELIGENCIA ARTIFICIAL GENERATIVA EN EL DESARROLLO DE APLICACIONES EMPRESARIALES: CASO DE ESTUDIO EN EL SECTOR DE SEGUROS Y REASEGUROS}
...
\grado{MAGÍSTER EN INGENIERÍA DE SISTEMAS}
